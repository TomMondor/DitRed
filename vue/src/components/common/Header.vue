<template>
	<div class="hp-header">
		...
		<div class="hp-display-links">
			<router-link to="/"
				><font-awesome-icon class="hp-header-icon" icon="fa-solid fa-list-ul"
			/></router-link>
			<router-link to="/subbed"
				><font-awesome-icon class="hp-header-icon" icon="fa-solid fa-heart"
			/></router-link>
			<router-link to="/user"
				><font-awesome-icon class="hp-header-icon" icon="fa-solid fa-user"
			/></router-link>
